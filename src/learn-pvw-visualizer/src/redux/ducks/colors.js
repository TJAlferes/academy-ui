...
const externalActions = {network: netActions, proxies: proxiesActions};
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case UPDATE_PIECE_WISE_FUNCTION: {
      const piecewiseFunctions = Object.assign(
        {},
        state.piecewiseFunctions,
    ...
    case UPDATE_PIECE_WISE_GUASSIANS: {
      const piecewiseGaussians = Object.assign(
        {},
        state.piecewiseGaussians,
    ...
    case REMOVE_SERVER_PIECE_WISE_FUNCTION: {
      ...
      action.arrayNames.forEach(name => delete piecewiseFunctionsToPush[name]);
...
export function pushPendingServerOpacityPoints() {
  return (dispatch, getState) => {
    ...
    arrayNames.forEach(name => dispatch(applyOpacityPoints(name, map[name])));
