...
Object.assign(Box3.prototype, {
    ...
    // test against axes that are given by cross product combinations of
    // the edges of the triangle and the edges of the aabb
    // make an axis testing of each of the 3 sides of the aabb against each of
    // the 3 sides of the triangle = 9 axis of separation
    // axis_ij = u_i x f_j
    // (u0, u1, u2 = face normals of aabb = x,y,z axes vectors since aabb is axis aligned)
		var axes = [
    ...
    // not slightly empty with non-inf/+inf values that will cause
...
function satForAxes(axes, v0, v1, v2, extents) {
    ...
    var r = extents.x *
    Math.abs(_testAxis.x) +
    extents.y *
    Math.abs(_testAxis.y) +
    extents.z *
