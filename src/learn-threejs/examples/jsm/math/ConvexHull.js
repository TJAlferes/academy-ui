...
/*
Note: There are 5 things going on here:
1. ConvexHull
2. Face
3. HalfEdge
4. VertexList
...
var ConvexHull = (function () {
    ...
    // Removes all the visible vertices that a given face is able to see
    // which are stored in the 'assigned' vertext list
		...
		deleteFaceVertices: function (face, absorbingFace) {
			...
			if (faceVertices !== undefined) {
				if (absorbingFace === undefined) {
					...
					do {
            // we need to buffer the subsequent vertex at this point
            // because the 'vertex.next' reference
						// will be changed by upcoming method calls
						var nextVertex = vertex.next;
						var distance = absorbingFace.distanceToPoint(vertex.point);

						// check if 'vertex' is able to see 'absorbingFace'
						if (distance > this.tolerance) this.addVertexToFace(vertex, absorbingFace);
		...
		computeInitialHull: function () {
          ...
          // the face is not able to see the point so 'plane.normal'
          ...
          // the face is able to see the point so 'plane.normal'
    ...
    // Creates a face with the vertices
    // 'eyeVertex.point', 'horizonEdge.tail' and 'horizonEdge.head' in CCW order
		addAdjoiningFace: function (eyeVertex, horizonEdge) {
      // all the half edges are created in ccw order
      // thus the face is always pointing outside the hull
      ...
      // remove 'eyeVertex' from 'eyeVertex.face'
      // so that it can't be added to the 'unassigned' vertex list
